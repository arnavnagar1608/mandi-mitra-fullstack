...
-- It creates all required tables, indexes, RLS policies, and seeds realistic data.
-- ============================================================================
...
CREATE TABLE IF NOT EXISTS public.procurement_centers (
    ...
    latitude DOUBLE PRECISION DEFAULT 22.7196,
    longitude DOUBLE PRECISION DEFAULT 75.8577,
...
-- Allow full access to backend service role and read access where needed
DO $$
DECLARE
    tbl text;
BEGIN
...
VALUES
    ('center-001', 'Indore APMC Main Yard', 'इंदौर मंडी मुख्य यार्ड', 'Indore', 'इंदौर', 'Sanwer Road', 'सांवेर रोड', 'Madhya Pradesh', 'Sector A, Sanwer Road Industrial Area, Indore, MP 452015', '+91 731 245 8890', 150, 8, 'low', '["wheat", "chana", "mustard", "soybean"]'::jsonb, 22.7533, 75.8711),
