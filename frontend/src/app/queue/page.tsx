  ...
  return (
    ...
    >
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
        ...
        {/* Top Header */}
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-[#E8DFD0] pb-6">
        ...
        {hasNoActiveBooking && (
          <div className="bg-[#FFFDF9] rounded-3xl p-6 sm:p-8 border border-[#D4912A]/40 shadow-sm flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              <AlertCircle className="w-6 h-6 text-[#D4912A] shrink-0" />
              <div>
                <h3 className="text-base font-bold text-[#3D3426]">
            ...
            <Link
              href="/centers"
              className="px-5 py-2.5 rounded-xl bg-[#5B7F3B] hover:bg-[#466B2A] text-white text-xs font-bold shrink-0 transition"
            >
          ...
          <button
            ...
            className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-[#FFFDF9] border border-[#E8DFD0] text-xs font-semibold text-[#6B5D4A] hover:text-[#3D3426] shadow-xs"
          >
        ...
        <div className="bg-[#FFFDF9] rounded-3xl p-6 sm:p-8 border border-[#E8DFD0] shadow-sm space-y-6">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 text-center">
            ...
            <div className="p-4 rounded-2xl bg-[#FAF3E6] border border-[#E8DFD0]">
              <span className="text-xs text-[#A89878] uppercase font-bold tracking-wider block mb-1">
            ...
            <div className="p-4 rounded-2xl bg-[#5B7F3B]/10 border border-[#5B7F3B]/20">
              <span className="text-xs text-[#5B7F3B] uppercase font-bold tracking-wider block mb-1">
                {t('queue.yourToken')}
              </span>
              <span className="text-4xl sm:text-5xl font-black text-[#5B7F3B] font-mono">
                #{myToken}
              </span>
            </div>
            ...
            <div className="p-4 rounded-2xl bg-[#FAF3E6] border border-[#E8DFD0]">
              ...
              <span className="text-4xl sm:text-5xl font-black text-[#3D3426] font-mono">
                {tokensAhead} <span className="text-sm font-sans text-[#6B5D4A]">ahead</span>
              </span>
            </div>
          ...
          <div className="p-4 rounded-2xl bg-[#D4912A]/10 border border-[#D4912A]/30 flex items-center gap-3.5">
            ...
            <p className="text-xs sm:text-sm font-semibold text-[#3D3426]">
        ...
        <div className="bg-[#FFFDF9] rounded-3xl p-6 sm:p-8 border border-[#E8DFD0] shadow-sm space-y-6">
          <h3 className="text-lg font-bold text-[#3D3426] font-serif border-b border-[#E8DFD0] pb-4">
            {language === 'hi' ? 'खरीद चरण की स्थिति' : 'End-to-End Procurement Progress'}
          </h3>

          <div className="relative pl-6 sm:pl-8 space-y-8 before:absolute before:left-3 sm:before:left-4 before:top-2 before:bottom-2 before:w-0.5 before:bg-[#E8DFD0]">
                ...
                <div key={stage.key} className="relative flex items-start gap-4">
                  ...
                  <div
                    className={`absolute -left-6 sm:-left-8 w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold transition-all ${
                      stage.done
                        ? 'bg-[#5B7F3B] text-white ring-4 ring-[#5B7F3B]/20'
                        : stage.current
                        ? 'bg-[#D4912A] text-white ring-4 ring-[#D4912A]/20 animate-pulse'
                        : 'bg-[#E8DFD0] text-[#A89878]'
                    }`}
                  >
                    {stage.done ? (
        ...
        <div className="bg-[#FAF3E6] rounded-3xl p-6 border border-[#E8DFD0] flex flex-col sm:flex-row items-center justify-between gap-6">
          <div className="space-y-2 text-center sm:text-left">
            <h4 className="text-base font-bold text-[#3D3426]">
            ...
            <div className="pt-2">
              <span className="text-xs font-mono font-bold bg-[#FFFDF9] px-3 py-1.5 rounded-lg border border-[#E8DFD0] text-[#3D3426]">
                {activeBookingObj?.qrCode || 'MM-TKN-SLOT-CONFIRMED'}
              </span>
            </div>
          </div>

          <div className="p-4 bg-[#FFFDF9] rounded-2xl border border-[#E8DFD0] shadow-xs">
            <QrCode className="w-20 h-20 text-[#3D3426]" />
          </div>
        </div>
      </div>
      </div>
