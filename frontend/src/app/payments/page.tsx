    ...
    >
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 border-b border-[#E8DFD0] pb-6">
          ...
          <div className="bg-[#FFFDF9] border border-[#E8DFD0] p-3.5 rounded-2xl flex items-center gap-3">
            <Building2 className="w-6 h-6 text-[#5B7F3B]" />
            <div className="text-xs">
              <span className="text-[#A89878] block">{currentFarmer.bankName}</span>
              <span className="font-bold text-[#3D3426]">A/C: •••• {currentFarmer.accountLast4}</span>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          ...
          <div className="bg-[#FFFDF9] rounded-3xl p-6 border border-[#E8DFD0] shadow-xs space-y-2">
            <div className="flex items-center justify-between text-xs text-[#A89878] font-bold uppercase">
              <span>{t('payments.totalEarned')}</span>
              <IndianRupee className="w-4 h-4 text-[#5B7F3B]" />
            </div>
            <div className="text-3xl font-black text-[#5B7F3B] font-serif">
          ...
          <div className="bg-[#FFFDF9] rounded-3xl p-6 border border-[#E8DFD0] shadow-xs space-y-2">
            <div className="flex items-center justify-between text-xs text-[#A89878] font-bold uppercase">
              ...
              <CheckCircle2 className="w-4 h-4 text-[#5B7F3B]" />
            </div>
            <div className="text-3xl font-black text-[#3D3426] font-serif">
        ...
        {/* TRANSACTIONS LEDGER */}
        <div className="bg-[#FFFDF9] rounded-3xl border border-[#E8DFD0] shadow-sm overflow-hidden space-y-4">
          ...
          <div className="divide-y divide-[#E8DFD0]/60">
            {paymentsList.map((p: any) => (
              <div key={p.id} className="p-6 flex flex-col md:flex-row md:items-center justify-between gap-4 hover:bg-[#FDF8F0]/50 transition">
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 rounded-2xl bg-[#5B7F3B]/10 text-[#5B7F3B] flex items-center justify-center shrink-0">
                    <ArrowDownRight className="w-6 h-6" />
                  </div>
                  <div className="space-y-1">
                    <div className="flex items-center gap-2">
                      <span className="text-base font-bold text-[#3D3426]">
                    ...
                    <div className="text-xs text-[#6B5D4A] space-y-0.5">
                      <p>UTN: <span className="font-mono text-[#3D3426]">{p.transactionRef}</span></p>
                ...
                <div className="flex items-center gap-3">
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl border border-[#E8DFD0] bg-[#FFFDF9] text-xs font-semibold text-[#3D3426] hover:bg-[#F5EDE0] transition"
                  >
